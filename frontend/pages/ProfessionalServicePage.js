...
export default {
    ...
    methods: {
        fetchServices() {
            this.loading = true;
            // Fetch services created by the current professional
            fetch('/service_professional/services', {
                method: 'GET',
                headers: {
    ...
    <div>
        ...
        <div class="container mt-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <button class="btn btn-success" @click="$router.push('/service_professional/services/add')">
            ...
            <div v-else-if="services.length === 0" class="text-center">
                <p class="fw-bold text-muted">You haven't added any services yet.</p>
                <button class="btn btn-primary mt-3" @click="$router.push('/service_professional/services/add')">
                    ...
                    <div class="card shadow-sm border-primary h-100">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end">
                                <button class="btn btn-primary btn-sm me-2" @click="$router.push('/service_professional/services/edit/' + service.id)">
