export default {
    template: `
      <nav class="navbar navbar-expand-lg" style="background-color:rgb(70, 202, 76);">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="adminNavbar">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item">
                <router-link class="nav-link" to="/serive_professional/profile" style="color: white; font-weight: 500;">Profile</router-link>
              </li>
            </ul>
            <!-- Logout Button -->
            <button 
