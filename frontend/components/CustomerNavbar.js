    ...
    template: `
      <nav class="navbar navbar-expand-lg" style="background-color: #19cc42;">
        <div class="container-fluid">
          <!-- Logo -->
          <a class="navbar-brand" href="#/customer/home" style="font-weight: bold; color: white;">
          ...
          <div class="collapse navbar-collapse" id="customerNavbar">
            <ul class="navbar-nav mx-auto">
              <li class="nav-item">
                <router-link class="nav-link" to="/customer/home" style="color: white; font-weight: 500;">Home</router-link>
              </li>
              <li class="nav-item">
